...
plant_co_located_plant_ids | string | For storage plants that are co-located with a generator at a different plant, the `plant_id_eia` of the other plant(s), separated by commas. Blank otherwise | [Calculated](../Methodology/Data%20Aggregation/Energy%20Storage.md)
