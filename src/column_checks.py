...
COLUMNS = {
    ...
    "annual_generation_averages_by_fuel_": {
        ...
        "generated_co2_mass_lb_per_mwh_for_electricity_adjusted",
        "generated_ch4_mass_lb_per_mwh_for_electricity_adjusted",
        "generated_n2o_mass_lb_per_mwh_for_electricity_adjusted",
        "generated_nox_mass_lb_per_mwh_for_electricity_adjusted",
        "generated_so2_mass_lb_per_mwh_for_electricity_adjusted",
    },
