...
def add_report_date(
    ...
    Args:
        ...
        load timezone data from the pudl plants entity table. However, in order to use
        this function where pudl cannot be read from s3, this provides the option to
        pass in your own plant timezone dataframe, for example loaded from
